...
async fn test_deny_list_enforced_for_coin_reservation() {
    ...
    // - crates/runtime-e2e-tests/tests/per_epoch_config_stress_tests.rs (uses deny_list_v2_add/remove)
    // - crates/runtime-e2e-tests/tests/rpc/v2/state_service/get_coin_info.rs::test_get_coin_info_regulated_coin
    //
    // Regulated coin modules:
    // - crates/runtime-e2e-tests/tests/move_test_code/sources/regulated_coin.move
    // - crates/runtime-e2e-tests/tests/rpc/data/regulated_coin/sources/regulated_coin.move
}
