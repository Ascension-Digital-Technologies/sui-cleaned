...
Go to `"$SUI"/move-vm/move/crates/move-analyzer/prettier-plugin` and run the following
command:
...
``` bash
npm install prettier@3.1.1 "$SUI"/move-vm/move/crates/move-analyzer/prettier-plugin
```
