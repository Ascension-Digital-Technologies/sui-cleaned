...
mod tests {
    ...
    fn test_workspace_read() {
        ...
        let move_core_types = root.join("crates/execution/move/language/core/move-core-types");
    ...
    fn test_cut_plan_discover() {
        ...
        let plan = CutPlan::discover(Args {
            ...
            directories: vec![
                ...
                Directory {
                    src: cut.join("../../../../execution/move/language/core/move-core-types"),
            ...
            CutPlan {
                ...
                packages: {
                    "move-core-types": CutPackage {
                        ...
                        src_path: "$PATH/crates/execution/move/language/core/move-core-types",
            ...
            new [workspace] excludes:
             - to:   move-core-types-feature
               ...
               from: move-core-types
                     crates/execution/move/language/core/move-core-types
    ...
    fn test_cut_plan_discover_new_top_level_destination() {
        ...
        let plan = CutPlan::discover(Args {
            ...
            directories: vec![
                ...
                Directory {
                    src: cut.join("../../../../execution/move-vm/move"),
