...
4. Link the move interface with the native function in [all_natives](https://github.com/MystenLabs/sui/blob/main/move-vm/move/crates/move-stdlib-natives/src/lib.rs#L146)
