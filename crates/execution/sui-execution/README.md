...
- `./sui-execution`, (latest version and cuts/copies of sui-specific
  crates).
- `./move-vm/move/move-execution` (cuts/copies of move-specific
  crates).
- `./move-vm/move` (the latest versions of move-specific
  crates).
...
- `./sui-execution/v0`
- `./move-vm/move/move-execution/v0`
...
`./crates/runtime-types` are shared across all versions.  Changes to
