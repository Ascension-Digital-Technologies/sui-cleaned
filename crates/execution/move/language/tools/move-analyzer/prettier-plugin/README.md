...
Go to `"$SUI"/crates/execution/move/language/tools/move-analyzer/prettier-plugin` and run the following
command:
...
``` bash
npm install prettier@3.1.1 "$SUI"/crates/execution/move/language/tools/move-analyzer/prettier-plugin
```
