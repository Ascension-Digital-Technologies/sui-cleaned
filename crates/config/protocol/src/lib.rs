...
// Version 45: Use tonic network for Mysticeti consensus.
...
// Version 48: Use tonic network for Mysticeti.
    ...
    fn get_for_version_impl(version: ProtocolVersion, chain: Chain) -> Self {
        ...
        for cur in 2..=version.0 {
            match cur {
                ...
                45 => {
                    // Use tonic network for consensus, in tests and devnet.
                    if chain != Chain::Testnet && chain != Chain::Mainnet {
                ...
                47 => {}
                48 => {
                    // Use tonic network for Mysticeti.
                    cfg.feature_flags.consensus_network = ConsensusNetwork::Tonic;
