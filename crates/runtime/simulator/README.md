...
The easiest way to write tests that run in the simulation testing framework is to use [SwarmBuilder](https://github.com/MystenLabs/sui/blob/main/crates/runtime-swarm/src/memory/swarm.rs#L47) to start your validators.
...
https://github.com/MystenLabs/sui/blob/main/crates/runtime/tests/checkpoints_tests.rs is a good example of this.
...
There is a small but growing library of functions for building network configs in [sui_simulator::configs](https://github.com/MystenLabs/sui/blob/main/crates/runtime-simulator/src/lib.rs).

There are also some examples of network configuration at https://github.com/MystenLabs/sui/blob/main/crates/runtime-benchmark/tests/simtest.rs#L52.
