...
1. Clone the `sui` repo locally. Open a Terminal or Console and go to the `sui/crates/runtime/sui-sdk` directory.
...
The [examples](https://github.com/MystenLabs/sui/tree/main/crates/runtime/sui-sdk/examples) folder provides both basic and advanced examples.
...
See the programmable transactions [example](https://github.com/MystenLabs/sui/blob/main/crates/runtime/sui-sdk/examples/programmable_transactions_api.rs).
