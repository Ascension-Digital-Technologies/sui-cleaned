...
//! (see [here](https://github.com/stefan-mysten/sui/tree/rust_sdk_api_examples/crates/runtime/sui-sdk/examples#preqrequisites) for more information).
//!
//! ```rust,no_run
...
//! in the [main repository](https://github.com/MystenLabs/sui/tree/main/crates/runtime/sui-sdk/examples).
